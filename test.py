...
#         torch.save(model, './best_hair_model.pth')
#         print('Model saved!')
...
best_model = torch.load('./best_hair_model.pth')
...
for i in range(10):
    ...
    plt.savefig(f'{result_dir}/images/{i}.png')
    plt.imshow(pr_mask, cmap='gray')
    plt.savefig(f'{result_dir}/masks/{i}.png')
    # visualize(
    #     image=image_vis, 
